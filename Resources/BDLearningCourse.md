...
Новое определение тиблицы и первичного ключа будет выглядеть следующим образом:
```
