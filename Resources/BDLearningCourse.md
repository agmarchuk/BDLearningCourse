...
Для выполнения задания, создадим в рабочей области проект дестопного C# Core приложения. Поставим его как главного. Проверим. Нам понадобится также базовая библиотека Поляра. Подгрузим ее через NuGet PolarDB. В данном примере используем Polar.DB
