...
Hello!
``` 
Измените переменную resp_message на это значение и у Вас возможно браузел получит желаемое Hello! Обратите внимание на то, что перед строчкой с данными (Hello!) есть пустая строка (символ \n), а Content-Length должен совпадать с числом байтов в данных. 
