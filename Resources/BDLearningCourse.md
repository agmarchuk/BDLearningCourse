...
## Task06_Server: Простое серверное приложение
...
В технологии .NET Core, с привлечением технологий XML и LINQ это не так сложно, что и будет продемонстрировано в данном задании. Задание выполним в (уже подзабытой) инструментальной системе Visual Studio Code. 

Запустим приложение Visual Studio Code, откроем директорию Вашего решения
Запустим интерпретатор командной строки, он есть встро Создадим директорию для проекта,   
