...
Теперь для большего удобства разработки, перейдем в VisualStudio. Там просто добавим к Вашему решению этот начальный вариант проекта. Можно даже не закрывать Visual Studio Code. 
